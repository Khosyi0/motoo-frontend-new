...
export function CompanyAdd() {
    ...
    const [previewLogo, setPreviewLogo] = useState(null); // State for logo preview
    ...
    return (
        <>{loadPage ?
            <form onSubmit={handleSubmit} className="container mx-auto p-4">
                <div className="font-bold text-lg">Add Company Data</div>
                <div className="grid grid-cols-1 gap-4 py-2">
                    ...
                    {previewLogo && (
                        <div>
                            <img src={previewLogo} alt="Logo Preview" className="max-w-xs mt-2" />
                        </div>
                    )}
                </div>
